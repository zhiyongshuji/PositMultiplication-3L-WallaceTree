...
HD_PWD='E:/myProjects/vivadoProjects/multiplier/multiplier.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log multiplier_88.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source multiplier_88.tcl

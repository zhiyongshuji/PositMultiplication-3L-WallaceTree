...
HD_PWD='E:/myProjects/vivadoProjects/multiplier/multiplier.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log multiplier_88.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source multiplier_88.tcl -notrace
